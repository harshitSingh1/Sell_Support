...
$param_shop_no = $_SESSION["sh_phone"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($phone_err) && empty($date_err)){
        ...
        $sql = "INSERT INTO record (shop_no, name, phone, date, product1, cost1, product2, cost2, product3, cost3, product4, cost4, product5, cost5, more_products) 
        VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssssssssssss",$param_shop_no, $param_name, $param_phone, $param_date, $param_product1, $param_cost1, $param_product2, $param_cost2, $param_product3, $param_cost3, $param_product4, $param_cost4, $param_product5, $param_cost5, $param_more_products);
            // Set parameters
...
<body>
	...
	<form form action="" method="post">
		...
		<br>
		<div class="row">
			<a><button onclick="myFunction()" class="glow-on-hover" type="submit">SUBMIT</button></a>
