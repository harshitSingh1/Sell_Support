...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($phone_err) && empty($password_err)){
        ...
        $sql = "SELECT id,name, phone, password FROM customers WHERE phone = ?";
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        ?>
            ...
            <div class="form-group">
                <input type="text" name="phone" required placeholder="Enter Phone Number" class="form-control <?php echo (!empty($phone_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $phone; ?>">
